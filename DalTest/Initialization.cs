...
namespace DalTest
{
    ...
    public static class Initialization
    {
        ...
        /// <summary>
        /// Provide the concrete DAL instances to be used by the initializer.
        /// Call this before calling <see cref="Do"/>.
        /// </summary>
        public static void InitWithDalInstances(ICourier courier, IOrder order, IDelivery delivery, IConfig config)
        {
        ...
        private static void EnsureDalSet()
        {
            if (s_dalCourier == null || s_dalDelivery == null || s_dalOrder == null || s_dalConfig == null)
            {
                throw new InvalidOperationException("DAL instances are not set. Call InitWithDalInstances(...) before calling Do().");
            }
        }
