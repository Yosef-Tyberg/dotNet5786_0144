...
public class NullableDoubleConverter : IValueConverter
{
    ...
    public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
    {
        ...
        if (string.IsNullOrWhiteSpace(s))
        {
            ...
            // If the target is a regular double, return 0.0 to trigger BL validation (e.g. "Volume must be positive")
            return 0.0;
        }

        if (double.TryParse(s, NumberStyles.Any, CultureInfo.InvariantCulture, out var d)) return d;
        
        // For invalid input (e.g. "abc"), return 0.0 to trigger BL validation
        return 0.0; 
    }
}
...
public class StringToIntConverter : IValueConverter
{
    ...
    public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
    {
        ...
        return int.TryParse(s, NumberStyles.Integer, CultureInfo.InvariantCulture, out var result) ? result : 0;
    }
}